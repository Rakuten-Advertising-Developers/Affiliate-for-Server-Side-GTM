...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Rakuten Advertising - Affiliate Server-Side (Official) gap update",
  "categories": [
    "AFFILIATE_MARKETING"
  ],
  "brand": {
  ...
  "description": "This is the official Rakuten release and supports the server-side integration of the Rakuten Advertising affiliate tag.",
  "containerContexts": [
    "SERVER"
  ]
}
